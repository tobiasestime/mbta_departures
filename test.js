...
/* Test that empty, header only, and complete CSV return at least timestamp */
var files = ['testEmpty.csv', 'testHeader.csv', 'testComplete.csv'];

/* Read in files and detect timestamp */
files.forEach((file) => {
	fs.readFile('./testFiles/' + file, 'utf8', function (err, data) {
...
/* Test times outputted by makeHumanReadable; 1 day with 30 minute intervals between hours (GMT) */
...
/* Values the makeHumanReadable should output using inputTimes */
